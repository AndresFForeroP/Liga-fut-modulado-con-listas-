...
Fecha : 29/enero/2025
nombre : liga futball
descripcion: el programa permite agregar equipos con todos sus datos, la cantidad de equipos que se pueden ingresar son infinitos 
"""
import os
menu1 = 0
iEquipos = 1
...
nFechas = []
while menu1 != 9:
    #inicializo variables para entontrar los indices de las listas mas adelante
    ijugador = 1
    ict = 1
    icmd = 1
    menu2 = 0
    try:
        menu1 =int(input("""       ⚽    MENU PRINCIPAL   ⚽
        1.Registro equipos
        2.Mostrar todos los equipos
        3.Registro fechas partidos
        9.Salir 
Ingrese segun el menu que desea realizar """))
    except Exception:
    ...
    match menu1:
        case 1:
            ...
            while menu2 != 9:
                os.system('clear')
                print("""       MENU REG:EQUIPOS
1.Registro jugador
2.Registro CT
3.Registro CMD
4.Registrar estadisticas equipo
9.Volver al menu anterior""")
                try:
                    menu2=int(input('Ingrese segun el menu que desea realizar '))
                except Exception:
                    print("valor invalido,solo ingrese el numero de la opcion del menu")
                os.system('clear')
                match menu2:
                    case 1:
                        ...
                        equipos[len(equipos)-1][1][ijugador].append(dorsal)
                        edad = 0
                        while edad <= 0:
                            try:
                        ...
                        equipos[len(equipos)-1][1][ijugador].append(edad)
                        pos1 = 0
...
4.Portero""")
                        ...
                        match pos1:
                            ...
                            case 4:
                                pos = 'Portero'
                        equipos[len(equipos)-1][1][ijugador].append(pos)
                        ijugador += 2
                    case 2:
                        ...
                        equipos[len(equipos)-1][3][ict].append(cargo)
                        edad = 0
                        while edad <= 0:
                            try:
                                ...
                                print = "inserta una edad valida en numero entero mayor a 0"
                        equipos[len(equipos)-1][3][ict].append(edad)
                        ict += 2
                    case 3:
                        ...
                        equipos[len(equipos)-1][5][icmd].append(cargo)
                        edad = 0
                        while edad <= 0:
                            try:
                                ...
                                print = "inserta una edad valida en numero entero mayor a 0"
                        equipos[len(equipos)-1][5][icmd].append(edad)
                        icmd += 2
                    case 4:
        ...
        case 3:
            ...
            for i in range(0,cFechas):
                ...
                #este bloque se usa para asignar las fechas a los partidos e imprimir la lista cada vez que se registra un fecha 
                #y se le asigna un partido,solo se podra asignar equipos a la fecha si hay 2 o mas equipos
                #almacena los datos en la lista y luego imprimer las fechas de los partidos y quienes lo juegan de la siguiente manera.
                #el dia del partido 03/02/2025
                #se jugara un partido entre colombia y argentina
